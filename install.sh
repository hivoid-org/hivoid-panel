...
setup_backend() {
    ...
    "${VENV_DIR}/bin/pip" install requests psutil bcrypt qrcode[pil] pyotp fastapi uvicorn sqlalchemy aiosqlite python-jose[cryptography] python-multipart pydantic-settings slowapi websockets -q
